...
{
    protected $fillable=['title','slug','summary','description','cat_id','child_cat_id','price','brand_id','discount','commission','status','photo','size','stock','is_featured','condition'];
