    ...
    <div class="card-body">
      <form method="post" action="{{route('banner.store')}}" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <small class="text-muted">Chọn ảnh banner (JPEG, PNG, GIF). Sẽ được lưu vào public/photos/</small>
        </div>
        ...
        <div class="input-group">
          ...
          <input id="thumbnail" class="form-control" type="text" name="photo" value="{{old('photo')}}" placeholder="Hoặc nhập đường dẫn ảnh">
        </div>
