    ...
    <div class="card-body">
      <form method="post" action="{{route('product.store')}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input id="commission" type="number" name="commission" min="0" max="100" step="0.01" placeholder="Enter commission percentage"  value="{{old('commission')}}" class="form-control">
          @error('commission')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
