...
<script type="text/javascript">
  ...
  function drawChart()
  {
      ...
      var options = {
          title : 'Người dùng đăng ký trong 7 ngày qua'
      };
  ...
  {{-- line chart --}}
  <script type="text/javascript">
    // Use a unique name to avoid collisions with other scripts
    const incomeApiUrlAdmin = "{{route('product.order.income')}}";

    // Only run if the canvas exists and Chart/axios are available
