...
@section('title', 'Admin Chat System')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4><i class="fas fa-comments"></i> Admin Chat System</h4>
                    <div class="badge badge-danger">Admin Panel</div>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-header bg-primary text-white">
                                    <h6 class="mb-0"><i class="fas fa-users"></i> All Users & Sub Admins</h6>
                                    <small>Admin can chat with everyone</small>
                                </div>
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <small class="text-muted">
                                                        ...
                                                        @if($availableUser->role == 'user' && $availableUser->parentSubAdmin)
                                                            <br><span class="text-xs">Managed by: {{ $availableUser->parentSubAdmin->name }}</span>
                                                        @endif
                                                    </small>
                                                </div>
                                                <div>
                            ...
                            <div class="card bg-warning text-white">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h4 class="mb-0">{{ $availableUsers->where('role', 'sub_admin')->count() }}</h4>
